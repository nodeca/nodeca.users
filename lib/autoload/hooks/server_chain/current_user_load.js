...
module.exports = function (N) {
  ...
  //
  N.wire.before('server_chain:*', { priority: -65 }, function fill_session_from_TokenLogin(env, callback) {
  ...
  //
  N.wire.before('server_chain:*', { priority: -65 }, function check_session_token_expiration(env, callback) {
    if (!env.session) {
      // No session.
      callback();
      return;
