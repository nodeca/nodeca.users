...
module.exports = function (N) {
  ...
  N.wire.skip('server_chain:http:users.auth.oauth.callback',       'http_force');
  N.wire.skip('server_chain:http:users.auth.oauth.error_show',     'http_force');

  N.wire.skip('server_chain:rpc:users.auth.oauth.remember_action', 'http_force');
