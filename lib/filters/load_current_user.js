...
var fetch_guests_usergroup = nodeca.components.memoizee(function (shortName, callback) {
  nodeca.models.users.UserGroup.findOne({ short_name: shortName }).exec(callback);
