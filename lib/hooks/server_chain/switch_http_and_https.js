...
// `general_security_policy` global setting.
//
...
module.exports = function (N) {
  ...
  // Helper to read "general_security_policy" setting used by next hooks.
  function isEncryptionRequired(env, callback) {
    N.settings.get('general_security_policy', {}, function (err, policy) {
      if (err) {
        callback(err);
        return;
      }
      ...
      default:
        ...
        callback('Value of setting "general_security_policy" is unknown: ' +
