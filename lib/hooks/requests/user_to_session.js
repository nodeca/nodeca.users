...
module.exports = function (N) {
  ...
  var findUsergroupId = memoizee(function (shortName, callback) {
    N.models.users.UserGroup
      ...
      if (!group) {
        callback(new Error('Unable to find special usergroup "' + shortName + '"'));
        return;
      }
    ...
    N.models.users.User
      ...
      .exec(function (err, user) {
        ...
        findUsergroupId('validating', function (err, validatingId) {
          env.runtime.is_validating = _.any(user.usergroups, function (groupId) {
