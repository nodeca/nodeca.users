...
N.wire.on('navigate.done:admin.users.members.edit', function initialize_datepicker() {
...
N.wire.on('navigate.exit:admin.users.members.edit', function teardown_datepicker() {
  if (picker) {
    picker.destroy();
    picker = null;
  }
